...
EPIC_MONO=""
if [ -f "F:\Juegos_epic_games\UE_4.22\Engine\Build\BatchFiles\Mac\SetupMono.sh" ]; then
    pushd "F:\Juegos_epic_games\UE_4.22\Engine\Build\BatchFiles\Mac"
	source SetupMono.sh
    popd
else
	EPIC_MONO="NOTE: It seems this $0 was built from another platform and copied here.\nNOTE: Was expecting to setup mono via: "'F:\Juegos_epic_games\UE_4.22\Engine\Build\BatchFiles\Mac\SetupMono.sh';
fi
